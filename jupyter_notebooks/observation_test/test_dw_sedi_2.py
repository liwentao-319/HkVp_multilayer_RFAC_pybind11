...
maindir = "seismic_data"
stationname="2F_TB019"
datadir = f"{maindir}/{stationname}"
savedir=f"test_dw_sedi/{stationname}"
...
for i,dw in enumerate(dws):
    #plot spectral power
    do_Ac = Ac(datadir=datadir,suffix=f".{channel}.sac",tref=5.,pretime=-5,length=100,f1=f1,f2=f2,tcos=1,df=dw)
    
    do_Ac.cal_ACs()
    do_Ac.stack_ACs(0.04,0.08,0.002,0.003)
